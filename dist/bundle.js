...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.onUpdateUser = _this.onUpdateUser.bind(_this);
  ...
  _createClass(App, [{
    ...
    key: 'onCreateUser',
    value: function onCreateUser(user) {
      var _this3 = this;

      _axios2.default.post('/api/users', user).then(function (result) {
        return result.data;
      }).then(function (user) {
        _this3.setState({ users: [].concat(_toConsumableArray(_this3.state.users), [user]) });
      }).then(function () {
        return document.location.hash = '/users';
      }).catch(function (err) {
        return console.error(err);
      });
    }
    ...
    key: 'onUpdateUser',
    value: function onUpdateUser(user) {
      var _this4 = this;

      _axios2.default.put('/api/users/' + user.id, user).then(function (result) {
        return result.data;
      }).then(function (user) {
        var users = _this4.state.users.map(function (_user) {
    ...
    value: function onDeleteUser(id) {
      ...
      _axios2.default.delete('/api/users/' + id).then(function (result) {
        return result.data;
      }).then(function (user) {
        var users = _this5.state.users.filter(function (_user) {
          return _user.id !== id * 1;
        });
        _this5.setState({ users: users });
        document.location.hash = '/users';
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var onCreateUser = this.onCreateUser,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h1',
            null,
            'Acme Users CRUD React'
          ),
          _react2.default.createElement(_reactRouterDom.Route, { render: function render(_ref) {
              var location = _ref.location;
              return _react2.default.createElement(_Nav2.default, { path: location.pathname, users: users });
            } }),
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/users/create', render: function render() {
                return _react2.default.createElement(_UserCreate2.default, { onCreateUser: onCreateUser });
              } }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/users/:id', render: function render(_ref2) {
                var match = _ref2.match;
                return _react2.default.createElement(_User2.default, { users: users, id: match.params.id, onUpdateUser: onUpdateUser, onDeleteUser: onDeleteUser });
              } })
          )
        )
      );
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'li',
        { className: 'nav-item' },
        path === '/users' ? _react2.default.createElement(
          'span',
          { className: 'nav-link disabled' },
          'Users \xA0',
          _react2.default.createElement(
      ...
      _react2.default.createElement(
        'li',
        { className: 'nav-item' },
        path === '/users/create' ? _react2.default.createElement(
          'span',
          { className: 'nav-link disabled' },
          'Create New User'
        ) : _react2.default.createElement(
          _reactRouterDom.Link,
          { to: '/users/create', className: 'nav-link' },
          'Create New User'
        )
      )
    )
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { onSubmit: onSave },
          _react2.default.createElement('input', { value: name, onChange: onChangeName, className: 'form-control' }),
          _react2.default.createElement(
            'button',
            { disabled: !name.length, className: 'btn btn-primary' },
            'Create User'
          )
        )
      );
...
var User = function (_Component) {
  ...
  _createClass(User, [{
    key: 'setUser',
    value: function setUser(users, id) {
    ...
    key: 'render',
    value: function render() {
      var onChangeName = this.onChangeName,
          updateUser = this.updateUser;
      var _props = this.props,
          onDeleteUser = _props.onDeleteUser,
          id = _props.id;
      var name = this.state.name;
